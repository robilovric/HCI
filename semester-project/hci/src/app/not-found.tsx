...
export default function NotFound() {
  return (
    ...
    <div className="text-center">
      ...
      <Link href="/" className="mt-6 inline-block px-6 py-2 bg-black text-white rounded transition-all hover:bg-gray-600">
        Back to home
      </Link>
    </div>

    <div className="ml-8">
      <Image src="/images/404handling.png" alt="404 Image" width={500} height={500} />
    </div>
  </div>
);
};