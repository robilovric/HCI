import { PageProps, Post, PaginationProps } from "@/app/news&lifestyle/page";
import { extractPageAndLimit } from "@/app/news&lifestyle/lib/utils";
import { BASE_URL, DEFAULT_PAGE, DEFAULT_LIMIT } from "@/app/news&lifestyle/lib/constants";
